...
| 13 — PDF export | 2/3 | In progress — `13-02` complete 2026-04-08 |
...
---
*Roadmap updated: 2026-04-08 — Phase **13** plan **`13-02`** complete (PDF renderer + `pdf*` l10n). **Next:** **`13-03`** export UI / preview / share.*  
