...
- [ ] **I18N-03**: **German** locale provides complete translations for the same string catalog as English for the agreed in-scope screens and flows (shell, onboarding, logging, calendar, home, settings, export/import, lock, prediction/fertility-related copy surfaced in this milestone)
